...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998,4,21),1000.0,dpt1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 21), 2000.0, dpt2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1993, 5, 4), 1500.0, dpt3);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1945, 6, 3), 3500.0, dpt4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(1960, 8, 13), 7500.0, dpt4);
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", new DateTime(1990, 9, 23), 5500.0, dpt3);
